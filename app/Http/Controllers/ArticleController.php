...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Article::create($data);
        return redirect('/dashboard/article')->with('success', 'Informasi Kegiatan Berhasil Di Tambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->update($data);
        return redirect('/dashboard/article')->with('info', 'Informasi Kegiatan Berhasil Di Update');
