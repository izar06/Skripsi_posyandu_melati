...
<div class="main-content">
    <section class="section">
      ...
      <div class="section-body">
        <h2 class="section-title">Form Input Data Balita</h2>
          ...
          <div class="col-12">
            <div class="card">
              <form action="/dashboard/balita" method="POST">
                @csrf
                <div class="card-header">
                  <h4>Masukkan Data Balita Dengan Sesuai</h4>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="nama_balita">Nama Balita</label>
                        <input type="text" class="form-control @error('nama_balita') is-invalid @enderror"" name="nama_balita" placeholder="Nama Balita" value="{{ old('nama_balita') }}">
                        @error('nama_balita')
                            <div class="invalid-feedback">
                            {{ $message }}
                            </div>
