        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-inline">
              <h4>Data Posyandu</h4>
              <a href="/dashboard/bumil/create" class=" btn btn-primary mt-3">Tambah Data Ibu Hamil</a>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="/dashboard/bumil/{{ $item->id }}/edit" class="btn btn-info">
                        <i class="fa fa-pencil-alt"></i>
                        </a>
                        <form action="/dashboard/bumil/{{ $item->id }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
                        <button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">
                            <i class="fa fa-trash"></i>
